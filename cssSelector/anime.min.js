...
!(function (n, e) {
	...
	var H = function (b, e, M, t) {
		...
		function r(n) {
			...
			if (0 === a) return r;
			for (var l, d, p = n, h = e, g = e + 0.1, m = b, v = M, y = 0; 0 < (l = k((d = h + (g - h) / 2), m, v) - p) ? (g = d) : (h = d), 1e-7 < Math.abs(l) && ++y < 10; );
			return d;
		}
	};
	function r(n, e) {
	...
	function V(n) {
		...
		return w.rgb(n)
			...
			: w.hsl(n)
			? ((t = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec((t = n)) || /hsla\((\d+),\s*([\d.]+)%,\s*([\d.]+)%,\s*([\d.]+)\)/g.exec(t)),
			  (n = parseInt(t[1], 10) / 360),
			  (u = parseInt(t[2], 10) / 100),
			  (i = parseInt(t[3], 10) / 100),
			  (t = t[4] || 1),
			  0 == u ? (r = a = o = i) : ((r = c((u = 2 * i - (i = i < 0.5 ? i * (1 + u) : i + u - i * u)), i, n + 1 / 3)), (a = c(u, i, n)), (o = c(u, i, n - 1 / 3))),
			  "rgba(" + 255 * r + "," + 255 * a + "," + 255 * o + "," + t + ")")
			: void 0;
		function c(n, e, t) {
			return t < 0 && (t += 1), 1 < t && --t, t < 1 / 6 ? n + 6 * (e - n) * t : t < 0.5 ? e : t < 2 / 3 ? n + (e - n) * (2 / 3 - t) * 6 : n;
		}
	}
	function B(n) {
					...
					tweens: (function (n, t) {
						var e,
							...
							a =
								...
								w.arr(n) && (2 === (e = n.length) && !w.obj(n[0]) ? (n = { value: n }) : w.fnc(t.duration) || (r.duration = t.duration / e)),
								w.arr(n) ? n : [n]);
						return a
							.map(function (n, e) {
				...
				n.map(function (o) {
					return e.map(function (n) {
						var e,
							...
							r = o,
							a = b(r.target, n.name);
						if (a) return (t = (e = K(n, r))[e.length - 1]), { type: a, property: n.name, animatable: r, tweens: e, duration: t.end, delay: e[0].delay, endDelay: t.endDelay };
					});
				})
			),
			function (n) {
	...
	function L(n) {
		...
		var e,
			...
			r,
			a,
			k = D(e, { id: a, children: [], animatables: n, animations: t, duration: r.duration, delay: r.delay, endDelay: r.endDelay });
		h(k);
		function g() {
			var n = k.direction;
			...
			!k.began && 0 < k.currentTime && ((k.began = !0), b("begin")),
				...
				e <= n &&
					...
					k.remaining
						...
						: ((k.paused = !0), k.completed || ((k.completed = !0), b("loopComplete"), b("complete"), !k.passThrough && "Promise" in window && (p(), h(k)))));
		}
		return (
			(k.reset = function () {
				var n = k.direction;
